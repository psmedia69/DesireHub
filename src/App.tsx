...
import { MousePointer2, Compass, Star, Heart, Sparkles, Send } from "lucide-react";
          ...
          {viewMode === "Phone" && (
            <div className="flex items-center justify-center w-full mb-8 z-20">
              <div className="relative rounded-[2rem] overflow-hidden group w-full border border-gold/30 shadow-[0_0_30px_rgba(212,175,55,0.15)]">
                <div className="relative bg-black/90 px-8 py-5 flex items-center justify-center h-full backdrop-blur-[26.4px]">
                  <a href="https://t.me/+fiYQGTL55EdkMDI1" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-gold transition-all hover:scale-125 active:scale-90 relative z-10 flex items-center gap-3 group" title="Telegram">
                    <Send className="w-8 h-8" />
                    <span className="text-[10px] font-black uppercase tracking-[0.2em]">Join Telegram</span>
                  </a>
                </div>
              </div>
            </div>
